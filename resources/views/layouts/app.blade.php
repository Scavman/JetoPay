...
<head>
    <meta charset="utf-8">
    <title>{{ config('app.name', 'JetoPay') }}</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        <a href="" class="navbar-brand ml-lg-3">
            <h1 class="m-0 display-5"><img src="https://cdn.builder.io/api/v1/image/assets/TEMP/1437405f-a6dd-4cb2-8327-15ed2957f5c1?"></h1>
        </a>
        ...
        <div class="collapse navbar-collapse px-lg-3" id="navbarCollapse">
            <div class="navbar-nav m-auto py-0">
                <a href="#aboutus" class="nav-item nav-link active">Company</a>
                <a href="#advantages" class="nav-item nav-link">Advantages</a>
